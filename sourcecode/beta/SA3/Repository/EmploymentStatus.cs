...
public partial class EmploymentStatus
{
	...
	[NotMapped]
	public string SqlInsertQuery => @"INSERT INTO [dbo].[EmploymentStatusList]([EmploymentIdentifier],[InstitutionIdentifier],[ActivationDate],[DeactivationDate],[EmploymentStatusCode],[MarkedForDeletion]) VALUES('"+
		this.EmploymentIdentifier+@"','"+this.InstitutionIdentifier+@"','"+this.ActivationDate.ToString("yyyy-MM-dd")+@"','"+this.DeactivationDate.ToString("yyyy-MM-dd")+@"','"+this.EmploymentStatusCode+@"','"+
		this.MarkedForDeletion.ToString()+"')";
	...
	[NotMapped]
	public string SqlUpdateQuery => @"UPDATE [dbo].[EmploymentStatusList] SET [EmploymentIdentifier]='"+this.EmploymentIdentifier+"',[InstitutionIdentifier]='"+this.InstitutionIdentifier+"',[ActivationDate]='"+
		this.ActivationDate.ToString("yyyy-MM-dd")+"',[DeactivationDate]='"+this.DeactivationDate.ToString("yyyy-MM-dd")+@"',[EmploymentStatusCode]='"+this.EmploymentStatusCode+
		@"',[MarkedForDeletion]='"+this.MarkedForDeletion.ToString()+@"' WHERE [Id]="+this.Id;
