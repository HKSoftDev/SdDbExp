...
/// <summary>Initializes a new instance of SuccessfulRun</summary><param name="institutionId" /><param name="sdApi" /><param name="runDate" />
	...
	public string SqlInsertQuery => "INSERT INTO [dbo].[SuccessfulRunList]([InstitutionIdentifier],[SdApi],[RunDate]) VALUES('"+this.InstitutionIdentifier+"','"+this.RunDate+"','"+this.SdApi+"')"+Environment.NewLine;
	...
	[NotMapped]
	public string SqlUpdateQuery => @"UPDATE [dbo].[SuccessfulRunList] SET [InstitutionIdentifier]='"+this.InstitutionIdentifier+"',[SdApi]='"+this.SdApi+@"',[RunDate]='"+ this.RunDate+@"' WHERE [Id]="+this.Id+Environment.NewLine;
