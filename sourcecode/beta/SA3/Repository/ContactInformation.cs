...
public partial class ContactInformation
{
	...
	[NotMapped]
	public string SqlInsertQuery => "INSERT INTO [SD].[dbo].[ContactInformationList]([ParentIdentifier],[InstitutionIdentifier],[TelephoneNumberIdentifier1],[TelephoneNumberIdentifier2],[EmailAddressIdentifier1],"+
		"[EmailAddressIdentifier2]) VALUES('"+this.ParentIdentifier+"','"+this.InstitutionIdentifier+"','"+this.TelephoneNumberIdentifier1+"','"+this.TelephoneNumberIdentifier2+"','"+ this.EmailAddressIdentifier1+
		"','"+this.EmailAddressIdentifier2+"')"+Environment.NewLine;
	...
	[NotMapped]
	public string SqlUpdateQuery => @"UPDATE [SD].[dbo].[ContactInformationList] SET [ParentIdentifier]='"+this.ParentIdentifier+"',[InstitutionIdentifier]='"+this.InstitutionIdentifier+"',[TelephoneNumberIdentifier1]='"+
		this.TelephoneNumberIdentifier1+"',[TelephoneNumberIdentifier2]='"+this.TelephoneNumberIdentifier2+"',[EmailAddressIdentifier1]='"+this.EmailAddressIdentifier1+"',[EmailAddressIdentifier2]='"+
		this.EmailAddressIdentifier2+"' WHERE [Id]="+this.Id+Environment.NewLine;
