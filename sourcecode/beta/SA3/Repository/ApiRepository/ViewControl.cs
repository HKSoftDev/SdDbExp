...
public partial class ViewControl
{
	...
	/// <remarks/>
	public const string CsvHeader="Cpr;Tjenestenummer;Beskæftigelsesrate;Silo;Afdeling;Fornavn;Efternavn;Email1;Email2;DI_User;Beskæftigelse\r\n";
	...
	/// <param name="afdeling" /><param name="fornavn" /><param name="efternavn" /><param name="email1" /><param name="email2" /><param name="beskæftigelse" />
	public ViewControl(string cpr,string tjenestenr,string beskæftigelsesrate,string silo,string afdeling,string fornavn,string efternavn,string email1,string email2,string beskæftigelse) {
		this.Cpr=cpr; this.Tjenestenummer=tjenestenr; this.Beskæftigelsesrate=beskæftigelsesrate; this.Silo=silo; this.Afdeling=afdeling; this.Fornavn=fornavn; this.Efternavn=efternavn;
		this.Email1=email1; this.Email2=email2; this.Beskæftigelse=beskæftigelse; }
	...
	public ViewControl(ViewControl entity) { this.Cpr=entity.Cpr; this.Tjenestenummer=entity.Tjenestenummer; this.Beskæftigelsesrate=entity.Beskæftigelsesrate; this.Silo=entity.Silo;
		this.Afdeling=entity.Afdeling; this.Fornavn=entity.Fornavn; this.Efternavn=entity.Efternavn; this.Email1=entity.Email1; this.Email2=entity.Email2; this.Beskæftigelse=entity.Beskæftigelse; }
	...
	/// <remarks />
	[JsonProperty("Beskæftigelse")][XmlElement("Beskæftigelse")]
	public string Beskæftigelse { get; set; } = null!;
	...
	/// <remarks/>
	public string CsvValue => this.Cpr+";"+this.Tjenestenummer+";"+this.Beskæftigelsesrate+";"+this.Silo+";"+this.Afdeling+";"+this.Fornavn+";"+this.Efternavn+";"+this.Email1+";"+this.Email2+";"+this.DI_User+";"+this.Beskæftigelse+"\r\n";
