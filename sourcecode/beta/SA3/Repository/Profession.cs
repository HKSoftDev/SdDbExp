...
public partial class Profession
{
	...
	[NotMapped]
	public string SqlInsertQuery => @"INSERT INTO [dbo].[ProfessionList]([ActivationDate],[DeactivationDate],[JobPositionIdentifier],[JobPositionName],[JobPositionLevelCode],[InstitutionIdentifier]) VALUES('"+
		this.ActivationDate.ToString("yyyy.MM.dd")+@"','"+this.DeactivationDate.ToString("yyyy.MM.dd")+@"','"+this.JobPositionIdentifier+@"','"+this.JobPositionName+@"','"+this.JobPositionLevelCode+@"','"+this.InstitutionIdentifier+"')\r\n";
	...
	[NotMapped]
	public string SqlUpdateQuery => @"UPDATE dbo.[ProfessionList] SET [ActivationDate]='"+this.ActivationDate.ToString("yyyy-MM-dd")+"',[DeactivationDate]='"+this.DeactivationDate.ToString("yyyy-MM-dd")+
		"',[JobPositionIdentifier]='"+this.JobPositionIdentifier+"',[JobPositionName]='"+this.JobPositionName.Replace("'", "′")+"',[JobPositionLevelCode]='"+this.JobPositionLevelCode+
