...
public partial class Employment
{
	...
	[NotMapped]
	public string SqlInsertQuery => @"INSERT INTO [SD].[dbo].[EmploymentList]([EmploymentIdentifier],[EmploymentDate],[AnniversaryDate],[InstitutionIdentifier],[Employee],[EmploymentDepartment],[EmploymentProfession]) "+
		"VALUES('"+this.EmploymentIdentifier+@"','"+this.EmploymentDate.ToString("yyyy-MM-dd")+@"','"+this.AnniversaryDate.ToString("yyyy-MM-dd")+@"','"+this.InstitutionIdentifier+@"','"+this.Employee+@"','"+
		this.EmploymentDepartment+@"','"+this.EmploymentProfession+"')\r\n";
	...
	[NotMapped]
	public string SqlUpdateQuery => @"UPDATE [SD].[dbo].[EmploymentList] SET [EmploymentIdentifier]='"+this.EmploymentIdentifier+@"', [EmploymentDate]='"+this.EmploymentDate.ToString("yyyy-MM-dd")+
		@"',[AnniversaryDate]='"+this.AnniversaryDate.ToString("yyyy-MM-dd")+@"',[InstitutionIdentifier]='"+this.InstitutionIdentifier+@"',[Employee]='"+this.Employee+@"',[EmploymentDepartment]='"+this.EmploymentDepartment+
		@"', [EmploymentProfession]='"+this.EmploymentProfession+@"' WHERE [Id]="+this.Id;
