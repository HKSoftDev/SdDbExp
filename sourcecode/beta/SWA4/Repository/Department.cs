...
public partial class Department
{
	...
	[NotMapped]
	public string SqlUpdateOrCreateQuery => @"EXECUTE [SD].[dbo].[UpdateOrCreateDepartment] @actDate='"+ActivationDate.ToString("yyyy-MM-dd")+"', @deactDate='"+DeactivationDate.ToString("yyyy-MM-dd")+"', @depUuid='"+DepartmentUuidIdentifier+"', @deptId='"+DepartmentIdentifier+"', @deptLevelId='"+DepartmentLevelIdentifier+"', @deptName='"+DepartmentName+"', @prodUnitId='"+ProductionUnitIdentifier+"', @instId='"+InstitutionIdentifier+"'";
