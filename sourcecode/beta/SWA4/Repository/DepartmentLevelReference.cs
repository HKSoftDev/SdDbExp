...
public partial class DepartmentLevelReference
{
	...
	[NotMapped]
	public string SqlUpdateOrCreateQuery => @"EXECUTE [SD].[dbo].[UpdateOrCreateDepartmentLevelReference] @deptLevelId'" + DepartmentLevelIdentifier + "', @orgStruct'" + OrganizationStructure + "', @senDeptLevelRef'" + SeniorDepartmentLevelReference + "'";
