...
public partial class Organization
{
	...
	[NotMapped]
	public string SqlUpdateOrCreateQuery => @"EXECUTE [SD].[dbo].[UpdateOrCreateOrganization] @actDate='"+ActivationDate.ToString("yyyy-MM-dd")+"', @deactDate='"+DeactivationDate.ToString("yyyy-MM-dd")+"', @instId='"+InstitutionIdentifier+"'";
