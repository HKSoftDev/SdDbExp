...
public class View3in1Person
{
	...
	public string Tjenestenummer { get; set; } = "00000";
	...
	public string Afdelingsid { get; set; } = "0NONE";

	/// <remarks/>
	[JsonProperty("Afdelingsuuid")][XmlElement("Afdelingsuuid")]
	public string Afdelingsuuid { get; set; } = "00000000-0000-0000-0000-000000000000";

	/// <remarks/>
	[JsonProperty("Afdelingsnavn")][XmlElement("Afdelingsnavn")]
	public string Afdelingsnavn { get; set; } = "None";

	/// <remarks/>
	[JsonProperty("Cpr")][XmlElement("Cpr")]
	public string Cpr { get; set; } = "0101001234";

	/// <remarks/>
	[JsonProperty("Fornavn")][XmlElement("Fornavn")]
	public string Fornavn { get; set; } = "Non";

	/// <remarks/>
	[JsonProperty("Efternavn")][XmlElement("Efternavn")]
	public string Efternavn { get; set; } = "Nomine";
