...
public partial class SalaryCodeGroup
{
	...
	[NotMapped]
	public string SqlInsertQuery => @"INSERT INTO [dbo].[SalaryCodeGroupList]([EmploymentIdentifier],[InstitutionIdentifier],[ActivationDate],[DeactivationDate],[PensionCode]) VALUES('"+this.EmploymentIdentifier+
		@"','"+this.InstitutionIdentifier+@"','"+this.ActivationDate.ToString("yyyy-MM-dd")+@"','"+this.DeactivationDate.ToString("yyyy-MM-dd")+ @"','"+this.PensionCode+"')";
	...
	[NotMapped]
	public string SqlUpdateQuery => @"UPDATE [dbo].[SalaryCodeGroupList] SET [EmploymentIdentifier]='"+this.EmploymentIdentifier+"',[InstitutionIdentifier]='"+this.InstitutionIdentifier+"',[ActivationDate]='"+this.ActivationDate.ToString("yyyy-MM-dd")+
		"',[DeactivationDate]='"+this.DeactivationDate.ToString("yyyy-MM-dd")+"',[PensionCode]='"+this.PensionCode+@"' WHERE[Id]="+this.Id;
