...
public partial class DepartmentReference
{
	...
	[NotMapped]
	public string SqlInsertQuery => @"INSERT INTO [SD].[dbo].[DepartmentReferenceList]([DepartmentIdentifier],[DepartmentUuidIdentifier],[DepartmentLevelIdentifier],[Organization],[SeniorDepartmentReference]) VALUES('"+
		this.DepartmentIdentifier+@"','"+this.DepartmentUuidIdentifier+@"','"+this.DepartmentLevelIdentifier+@"','"+this.Organization+@"','"+this.SeniorDepartmentReference+@"')";
	...
	[NotMapped]
	public string SqlUpdateQuery => @"UPDATE [SD].[dbo].[DepartmentReferenceList] SET [DepartmentIdentifier]='"+this.DepartmentIdentifier.Replace("'", "′")+@"',[DepartmentUuidIdentifier]='"+this.DepartmentUuidIdentifier+
		@"',[DepartmentLevelIdentifier]='"+this.DepartmentLevelIdentifier.Replace("'", "′")+@"',[Organization]='"+this.Organization+@"',[SeniorDepartmentReference]='"+this.SeniorDepartmentReference+@"' WHERE [Id]="+this.Id;
