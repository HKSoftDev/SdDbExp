...
public partial class WorkingTime
{
	...
	[NotMapped]
	public string SqlInsertQuery => @"INSERT INTO [dbo].[WorkingTimeList]([EmploymentIdentifier],[InstitutionIdentifier],[ActivationDate],[DeactivationDate],[OccupationRate],[SalaryRate],[SalariedIndicator],"+
		"[AutomaticRaiseIndicator],[FullTimeIndicator]) VALUES('"+this.EmploymentIdentifier+@"','"+this.InstitutionIdentifier+@"','"+this.ActivationDate.ToString("yyyy-MM-dd")+@"','"+
		this.DeactivationDate.ToString("yyyy-MM-dd")+@"','"+this.OccupationRate+@"','"+this.SalaryRate+@"','"+this.SalariedIndicator.ToString()+@"','"+this.AutomaticRaiseIndicator.ToString()+
		@"','"+this.FullTimeIndicator.ToString()+"')";
	...
	[NotMapped]
	public string SqlUpdateQuery => @"UPDATE [dbo].[WorkingTimeList] SET [EmploymentIdentifier]='"+this.EmploymentIdentifier+"',[InstitutionIdentifier]='"+this.InstitutionIdentifier+"',[ActivationDate]='"+
		this.ActivationDate.ToString("yyyy-MM-dd")+"',[DeactivationDate]='"+this.DeactivationDate.ToString("yyyy-MM-dd")+"',[OccupationRate]='"+this.OccupationRate+"',[SalaryRate]='"+this.SalaryRate+"',[SalariedIndicator]='"+
		this.SalariedIndicator.ToString()+"',[AutomaticRaiseIndicator]='"+this.AutomaticRaiseIndicator.ToString()+"',[FullTimeIndicator]='"+this.FullTimeIndicator.ToString()+"' WHERE [Id]="+this.Id;
