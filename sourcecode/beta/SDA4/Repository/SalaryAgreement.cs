...
public partial class SalaryAgreement
{
	...
	[NotMapped]
	public string SqlInsertQuery => @"INSERT INTO [dbo].[SalaryAgreementList]([EmploymentIdentifier],[InstitutionIdentifier],[ActivationDate],[DeactivationDate],[SalaryAgreementIdentifier],[SalaryClassIdentifier],"+
		"[SalaryScaleIdentifier],[PrepaidIndicator],[SeniorityDate]) VALUES('"+this.EmploymentIdentifier+"','"+this.InstitutionIdentifier+"','"+this.ActivationDate.ToString("yyyy-MM-dd")+
		"','"+this.DeactivationDate.ToString("yyyy-MM-dd")+"','"+this.SalaryAgreementIdentifier+"','"+this.SalaryClassIdentifier+"','"+this.SalaryScaleIdentifier+"','"+this.PrepaidIndicator.ToString()+
		"','"+this.SeniorityDate.ToString("yyyy-MM-dd")+"')";
	...
	[NotMapped]
	public string SqlUpdateQuery => @"UPDATE [dbo].[SalaryAgreementList] SET [EmploymentIdentifier]='"+this.EmploymentIdentifier+"',[InstitutionIdentifier]='"+this.InstitutionIdentifier+
		"',[ActivationDate]='"+this.ActivationDate.ToString("yyyy-MM-dd")+"',[DeactivationDate]='"+this.DeactivationDate.ToString("yyyy-MM-dd")+"',[SalaryAgreementIdentifier]='"+
		this.SalaryAgreementIdentifier+"',[SalaryClassIdentifier]='"+this.SalaryClassIdentifier+"',[SalaryScaleIdentifier]='"+this.SalaryScaleIdentifier+"',[PrepaidIndicator]='"+
		this.PrepaidIndicator.ToString()+"',[SeniorityDate]='"+this.SeniorityDate.ToString("yyyy-MM-dd")+@"' WHERE [Id]="+this.Id;
