...
public partial class EmploymentProfession
{
	...
	[NotMapped]
	public string SqlUpdateOrCreateQuery => @"EXECUTE [SD].[dbo].[UpdateOrCreateEmploymentProfession] @emplId='"+EmploymentIdentifier+"', @instId='"+InstitutionIdentifier+"', @jobPosId='"+JobPositionIdentifier+
		"', @actDate='"+ActivationDate.ToString("yyyy-MM-dd")+"', @deactDate='"+DeactivationDate.ToString("yyyy-MM-dd") + "', @emplName='"+EmploymentName+"', @appCode='"+AppointmentCode+"'";
