...
public partial class ViewKantine
{
	...
	/// <remarks/>
	public const string CsvHeader="Cpr;Tjenestenummer;Afdelingkode;Beskæftigelsesdecimal;Fornavn;Efternavn;Afdeling;StartDato;SlutDato;Jubi\r\n";
	...
	public ViewKantine(string cpr,string tjenestenummer,string afdelingkode,string beskæftigelsesdecimal,string fornavn,string efternavn,string afdeling,DateTime startDato,DateTime slutDato,DateTime jubi) {
		this.Cpr=cpr; this.Tjenestenummer=tjenestenummer; this.Afdelingkode=afdelingkode; this.Beskæftigelsesdecimal=beskæftigelsesdecimal; this.Fornavn=fornavn; this.Efternavn=efternavn; this.Afdeling=afdeling;
	...
	public ViewKantine(ViewKantine entity) { this.Cpr=entity.Cpr; this.Tjenestenummer=entity.Tjenestenummer; this.Afdelingkode=entity.Afdelingkode; this.Beskæftigelsesdecimal=entity.Beskæftigelsesdecimal; 
	...
	/// <remarks />
	[JsonProperty("Afdelingkode")][XmlElement("Afdelingkode")]
	public string Afdelingkode { get; set; } = null!;
	...
	/// <remarks/>
	public string CsvValue => this.Cpr+";"+this.Tjenestenummer+";"+this.Afdelingkode+";"+this.Beskæftigelsesdecimal+";"+this.Fornavn+";"+this.Efternavn+";"+this.Afdeling+";"+
	...
	public string ToXmlString() { string result="<ViewKantine creationDateTime=\""+DateTime.Now.ToString("yyyy-MM-ddThh:mm:ss")+"\">"+Environment.NewLine;
		...
		result += "    <Afdelingkode>"+Afdelingkode+"<\\Afdelingkode>"+Environment.NewLine;
