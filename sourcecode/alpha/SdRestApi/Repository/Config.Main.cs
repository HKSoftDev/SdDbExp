...
public partial class Config // Main
{
	...
	protected void FillFieldProps(Config config) { this.InstitutionIdentifier=config.InstitutionIdentifier; this.ActivationDate=config.ActivationDate; this.DeactivationDate=config.DeactivationDate;
		...
		this.FileName=config.FileName; this.Format=config.Format; this.PassWord=config.PassWord; this.RequestString=config.RequestString; this.ResponseString=config.ResponseString; this.Roles=config.Roles;
		this.RunMode=config.RunMode; this.Silo=config.Silo; this.WebServiceQueryString=config.WebServiceQueryString; this.WebServiceActionUri=config.WebServiceActionUri; }
