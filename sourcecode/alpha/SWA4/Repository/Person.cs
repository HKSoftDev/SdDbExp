...
public partial class Person
{
	...
	[NotMapped]
	public string SqlUpdateOrCreateQuery => @"EXECUTE [SD].[dbo].[UpdateOrCreatePerson] @cpr='"+PersonCivilRegistrationIdentifier+"', @givenName='"+PersonGivenName+"', @surName='"+PersonSurnameName+"', @instId='"+InstitutionIdentifier+"'";
