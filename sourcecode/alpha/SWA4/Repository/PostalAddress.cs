...
public partial class PostalAddress
{
	...
	[NotMapped]
	public string SqlUpdateOrCreateQuery => @"EXECUTE [SD].[dbo].[UpdateOrCreatePostalAddress] @parentId='"+ParentIdentifier+"', @instId='"+InstitutionIdentifier+"', @street='"+StandardAddressIdentifier+"', @zip='"+PostalCode+"', @town='"+DistrictName+"', @muniCode='"+MunicipalityCode+"', @country='"+CountryIdentificationCode+"'";
