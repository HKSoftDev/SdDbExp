// -----------------------------------------------------------------------------------------------------------------------------------------
// <copyright file="Exceptions.cs" company="Haderslev Kommune" author="Daniel Giversen" year="2022" reserved="All Rights" />
// <license file="License.txt" "type=Proprietary License" />
// -----------------------------------------------------------------------------------------------------------------------------------------
namespace Repository;

/// <Summary>Common Exception</Summary>
public class ArgumentEmptyException : ExpressionException
{
	...
	/// <remarks />
	public override string ToErrorString() { if (this==null) throw new NullReferenceException(); if (this.ExpressionName!=null&&this.ActualValue!=null) return Environment.NewLine+
			"- An ArgumentNullOrEmptyException occurred ("+this.ExpressionName+": "+this.ActualValue.ToString()+"):"+Environment.NewLine+this+Environment.NewLine;
		else if (this.ExpressionName!=null&&this.ActualValue==null) return Environment.NewLine+"- An ArgumentNullOrEmptyException occurred ("+this.ExpressionName+"):"+Environment.NewLine+
			this+Environment.NewLine; else return Environment.NewLine+"- An ArgumentNullOrEmptyException error occurred:"+Environment.NewLine+this+Environment.NewLine; }
