...
public partial class Config //Const Fields
{
	...
	/// <remarks />
	public const string ProductionUnitIndicator=@"&ProductionUnitIndicator=true", ProfessionIndicator=@"ProfessionIndicator=true", RegionIdentifier=@"&RegionIdentifier=8P", PassWord="Haderslev123";

	/// <remarks />
	public const string Roles="Haderslev", RegionUUIDIdentifier=@"&RegionUUIDIdentifier=", SalaryAgreementIndicator=@"SalaryAgreementIndicator=true", SalaryCodeGroupIndicator=@"&SalaryCodeGroupIndicator=true";
